...
public class CarritoHistorialService {
    ...
    public List<CarritoHistorialResponse> obtenerHistorial(@NonNull Long idCarrito) {
        log.info("Obteniendo el historial de carritos {}",
                idCarrito); // A traves del id del carrito, trae la informacion de cada uno para mostrar en
                            // historial
