...
import com.gestion.tienda.tcg.carrito.controller.CarritoControllerV2;
...
public class CarritoModelAssembler
    ...
    public @NonNull EntityModel<CarritoResponse> toModel(@NonNull CarritoResponse response) {
        return EntityModel.of(response,
                linkTo(methodOn(CarritoControllerV2.class).buscarPorId(response.getIdCarrito())).withSelfRel(),
