...
public class InventarioController {
    ...
    @GetMapping("/simple")
    public ResponseEntity<CollectionModel<EntityModel<InventarioDetalleResponse>>> listarInventariosConProductos() {
        ...
        return ResponseEntity.ok(CollectionModel.of(coleccion,
                linkTo(methodOn(InventarioController.class).listarInventariosConProductos()).withSelfRel()));
    }
    ...
    public ResponseEntity<EntityModel<InventarioResponse>> stockPorProducto(@Valid @PathVariable Long idProducto){
    ...
    public ResponseEntity<EntityModel<InventarioResponse>> aumentarStock(@PathVariable Long idProducto, @PathVariable Integer cantidad){
    ...
    public ResponseEntity<EntityModel<InventarioResponse>> disminuirStock(@PathVariable Long idProducto, @PathVariable Integer cantidad){
    ...
    @PutMapping
    public ResponseEntity<EntityModel<InventarioResponse>> ajustarStock(@RequestBody @Valid InventarioRequest request){
